        ...
        { this.showItems() }
        {
          ...
          <div className = 'bgItemGlobe'>
            <div
              ...
              <h1 className='infoColor' style = {{ 'color': multimedia[actualItem].itemInfo.color1 }}><i>{ multimedia[actualItem].itemInfo.globe}</i></h1>
             ...
             multimedia[actualItem].itemInfo.title ? <h4 className = 'mB-05 mL-1 F2' dangerouslySetInnerHTML = {{ __html: multimedia[actualItem].itemInfo.title }}></h4> : null
              ...
              {
                multimedia[actualItem].itemInfo.text ? <p className = 'tCenter mB-1 fw-4 #5C657C' dangerouslySetInnerHTML = {{ __html: multimedia[actualItem].itemInfo.text }}></p> : null
              }

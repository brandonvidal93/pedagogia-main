...
class Pyramid1 extends Component {
  ...
  render() {
    ...
    const style = {
      ...
      backgroundSize: 'auto',
      backgroundPosition: '199px 181px',
      ...
      <div className = 'Pyramid1' style = {{ ...style }}>
        { this.showItems() }
        {
          ...
          <div className = 'bgItemGlobe'>
            <div
              className = { 'itemGlobe  dF-C-cs mB-2 mL-2 animated fadeInDown ' + multimedia[actualItem].itemInfo.trian } style = {{ 'borderColor': multimedia[actualItem].itemInfo.color, 'top': multimedia[actualItem].itemInfo.posGlobe.posY, 'left': multimedia[actualItem].itemInfo.posGlobe.posX }}>

              {
                multimedia[actualItem].itemInfo.title ? <h4 className = 'mB-05 fw-5' dangerouslySetInnerHTML = {{ __html: multimedia[actualItem].itemInfo.title }}></h4> : null
              }

              {
                multimedia[actualItem].itemInfo.text ? <p className = 'fw-3' dangerouslySetInnerHTML = {{ __html: multimedia[actualItem].itemInfo.text }}></p> : null
              }
